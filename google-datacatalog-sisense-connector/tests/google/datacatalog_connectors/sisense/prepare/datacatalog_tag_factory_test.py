...
class DataCatalogEntryFactoryTest(unittest.TestCase):
    ...
    @mock.patch(f'{__PRIVATE_METHOD_PREFIX}__make_tag_for_jaql_filter_by')
    ...
    @mock.patch(f'{__PRIVATE_METHOD_PREFIX}__make_tag_for_jaql_filter_by',
                lambda *args: None)
    @mock.patch(f'{__PRIVATE_METHOD_PREFIX}__make_tags_for_jaql_formula')
    def test_make_tags_for_jaql_should_handle_formula_tags(
            self, mock_make_tags_for_jaql_formula):
        ...
        fake_tag.template = tag_template.name
        mock_make_tags_for_jaql_formula.return_value = [fake_tag, fake_tag]

        tags = self.__factory._DataCatalogTagFactory__make_tags_for_jaql(
            tag_template, metadata, 'test')

        # 1: the main JAQL tag generated by __make_tags_for_jaql().
        # 2 and 3: fake tags for the optional/nested formula parts.
    ...
    @mock.patch(f'{__PRIVATE_METHOD_PREFIX}__make_tags_for_jaql_formula',
                lambda *args: [])
    def test_make_tags_for_jaql_should_handle_filter_by_tag(
            self, mock_make_tag_for_jaql_filter_by):
        ...
        fake_tag = datacatalog.Tag()
        fake_tag.template = tag_template.name
        mock_make_tag_for_jaql_filter_by.return_value = fake_tag

        tags = self.__factory._DataCatalogTagFactory__make_tags_for_jaql(
            tag_template, metadata, 'test')

        # 1: the main JAQL tag generated by __make_tags_for_jaql().
        # 2: fake tag for the optional/nested filter.by JAQL object.
        self.assertEqual(2, len(tags))
    ...
    @mock.patch(f'{__PRIVATE_METHOD_PREFIX}__make_tags_for_jaql')
    def test_make_tags_for_jaql_formula_should_return_tags_for_all_parts(
            self, mock_make_tags_for_jaql):
    ...
    def test_make_tags_for_jaql_formula_should_return_empty_list_if_no_formula(
            self):
